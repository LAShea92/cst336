$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        $("#question3-feedback").append("The answer is <strong>Monterey</strong>");
        ...
        $("#question4-feedback").append("The answer was either <strong>blue</strong> or <strong>green</strong>");
